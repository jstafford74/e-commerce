...
const Footer = () => {
  ...
  return (
    // <!-- Footer container -->
    <footer className="bg-slate-950 text-center text-white text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4">
              <a href="/social-impact">Social Impact & Sustainability</a>
            </p>
            <p>
